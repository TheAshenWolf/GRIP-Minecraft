...
namespace VoxelWorld
{
    public static class Utils
    {
        ...
        public static float offset = 32000f;

        public static int GenerateHeight(float x, float z)
        {
            float height = Map(0, MAX_HEIGHT, 0, 1,
        ...
        public static float FractalBrownianMotion3D(float x, float y, float z, float sm = 0.1f, int oct = 3,
        ...
        {
            amplitude = World.levelData.amplitude;
            frequency = World.levelData.frequency;
            offset = World.levelData.offset;
